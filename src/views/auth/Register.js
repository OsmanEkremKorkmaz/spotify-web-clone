...
export default function Register() {
  ...
  return currentUser ? navigate("/", {replace:true}) : (
    ...
    <div className='w-full h-full'>
        ...
        <button className='flex items-center justify-around w-full mb-[22px]'>
            <div className='flex items-center w-[312px] justify-center border-2 border-[#535353] text-[#535353] font-semibold px-6 py-3 hover:scale-105 rounded-full bg-transparent'>
                <div className=' pr-4 '>
        ...
        >
            ...
            <Form>
                <h2 className='font-semibold text-lg text-center pb-4'>E-posta adresinle kaydol</h2>
                <div className='flex flex-col gap-y-6'>
                    <Input name="email" label="E-posta adresin nedir?" placeholder="E-posta adresini gir." />
                    <Input name="confirmEmail" label="E-posta adresini onayla" placeholder="E-posta adresini yeniden gir." />
                    <Input name="password" type="password" label="Parola oluştur" placeholder="Parola oluştur." />
                    <Input name="username" label="Sana hangi isimle hitap etmeliyiz?" placeholder="Profil adını gir." />
                </div>
                <span className='mt-2 text-sm'>Bu profilinde görünür.</span>
                <div className='py-6 flex flex-col gap-y-6 justify-around'>

                    <div className='text-center py-6'>
                        <p className=' text-xs'>Kaydol seçeneğine tıklayarak Spotify'ın <a className='text-secondary  underline' href="https://www.spotify.com/tr/legal/end-user-agreement/">Kullanım Hüküm ve Koşulları</a>  'nı kabul etmiş olursun.</p>
                        <p className=' text-xs'>Spotify'ın kişisel verilerini nasıl topladığı, kullandığı, paylaştığı ve koruduğu hakkında daha fazla bilgi edinmek için lütfen  <a className='text-secondary  underline' href="https://www.spotify.com/tr/legal/end-user-agreement/">Spotify Gizlilik Politikası</a>'nı oku.</p>
                    </div>
                    <div className='flex justify-around '>
                        <button className='bg-primary hover:bg-primary hover:scale-105 py-4 px-12 rounded-full font-semibold' type='submit'>Kaydol</button>
                    </div>
                    <p className='text-center'>Hesabın var mı? <Link className='underline text-secondary' to="/auth/login">Oturum aç</Link>.</p>
                </div>
            </Form>
        </Formik>
    </div>
